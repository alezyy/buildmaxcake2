 ...
 * Tenant Model
 *
 * @property Alternateemails $Alternateemails
 * @property Country $Country
 * @property State $State
 * @property City $City
 * @property Accounting $Accounting
 * @property Alternateemail $Alternateemail
 * @property ApplicationsLease $ApplicationsLease
 * @property Comptable1 $Comptable1
 */
